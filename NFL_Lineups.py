...
#optimizer.add_stack(TeamStack(2, for_positions=['QB', 'WR', 'WR']))  # stack 3 players with any of specified positions
lineup_generator = optimizer.optimize(30)
i = 1
AllLineups = []
...
exporter = CSVLineupExporter(optimizer.optimize(50, max_exposure = 30))
